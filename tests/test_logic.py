...
class TimeTests(unittest.TestCase):
    def test_calendar_ranges(self):
        """基准：FixedDateTime 今天 2026-09-07 16:00。含零宽三条（合法，查询自然得 0 行）。"""
        cases = {
            "2026": ("2026-01-01 00:00:00", "2027-01-01 00:00:00"),
            "2026-08": ("2026-08-01 00:00:00", "2026-09-01 00:00:00"),
            "2026-08-15": ("2026-08-15 00:00:00", "2026-08-16 00:00:00"),
            "08-15": ("2026-08-15 00:00:00", "2026-08-16 00:00:00"),
            "2024-02-29": ("2024-02-29 00:00:00", "2024-03-01 00:00:00"),
            "09-07": ("2026-09-07 00:00:00", "2026-09-08 00:00:00"),
            "2026-08-15/2026-08-18": ("2026-08-15 00:00:00", "2026-08-19 00:00:00"),
            "08-15/08-18": ("2026-08-15 00:00:00", "2026-08-19 00:00:00"),
            "2026-08/2026-09": ("2026-08-01 00:00:00", "2026-10-01 00:00:00"),
            "2026/2026": ("2026-01-01 00:00:00", "2027-01-01 00:00:00"),
            "08-15/08-15": ("2026-08-15 00:00:00", "2026-08-16 00:00:00"),
            "2026-12-31/2027-01-01": ("2026-12-31 00:00:00", "2027-01-02 00:00:00"),
            "2026-08-01/2026-09-07 09:00": ("2026-08-01 00:00:00", "2026-09-07 09:00:00"),
            "2026-09-07 09:00/2026-09-07 10:00": ("2026-09-07 09:00:00", "2026-09-07 10:00:00"),
            "2026-08-01 09:00/2026-08-01 17:00": ("2026-08-01 09:00:00", "2026-08-01 17:00:00"),
            "08-15 09:00/08-18 09:00": ("2026-08-15 09:00:00", "2026-08-18 09:00:00"),
            "09-11 23:00/09-12 01:00": ("2026-09-11 23:00:00", "2026-09-12 01:00:00"),
            "09:00/17:00": ("2026-09-07 09:00:00", "2026-09-07 17:00:00"),
            "09:00/": ("2026-09-07 09:00:00", "2026-09-07 16:00:00"),
            "2026/": ("2026-01-01 00:00:00", "2026-09-07 16:00:00"),
            "2026-08/": ("2026-08-01 00:00:00", "2026-09-07 16:00:00"),
            "2026-08-15/": ("2026-08-15 00:00:00", "2026-09-07 16:00:00"),
            "2026-08-15 09:00/": ("2026-08-15 09:00:00", "2026-09-07 16:00:00"),
            "09:00/09:00": ("2026-09-07 09:00:00", "2026-09-07 09:00:00"),
            "16:00/": ("2026-09-07 16:00:00", "2026-09-07 16:00:00"),
            "08-15/08-14": ("2026-08-15 00:00:00", "2026-08-15 00:00:00"),
        }
    ...
    def test_invalid_ranges(self):
        """三段：不展开·语法问题 17 + 不展开·缺法不一致 7 + 负宽 5（负宽依赖固定时钟）。"""
        with patch.object(datetime, "datetime", FixedDateTime):
            for text in (
                # 语法问题
                "", "bad", "2025-02-29", "13-01", "24:00", "09:60", "09:00-25:00",
                "09:00", "09:00-17:00", "2026-09-07 09:00", "23:00-01:00",
                "08-15 09:00-17:00", "/2026-08-15", "09:00/17:00/18:00",
                "2026-13", "08-32", "2026-08-15 25:00",
                # 缺法不一致：一端带日期、一端只写时刻或缺年
                "2026-08/17:00", "09:00/2026-08", "2026-08-15/08-18",
                "2026-08-01/17:00", "2026-09-07 09:00/10:00",
                "09:00/2026-08-15", "09:00/2026-09-07 10:00",
                # 负宽
                "2026-09/2026-07", "17:00/", "2027/",
                "12-31/01-01", "12-31 23:00/01-01 01:00"):
                with self.subTest(text=text):
